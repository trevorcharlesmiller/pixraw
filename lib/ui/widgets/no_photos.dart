...
class NoPhotos extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return (rawPhotos.directory != null &&
            rawPhotos.rawPhotoPaths.isEmpty &&
            rawPhotos.ratingFilter.isNotEmpty)
        ? Center(
            child: Column(
              ...
              children: [
                Text(
                  'No photos match the filters you have selected',
            ...
            child: Column(
              ...
              children: [
                if (rawPhotos.directory != null &&
                    rawPhotos.rawPhotoPaths.isEmpty &&
                    rawPhotos.ratingFilter.isEmpty)
                  Text(
                    'No RAW files were found in the\nfolder you selected.',
                    style: TextStyle(fontSize: 26),
                    textAlign: TextAlign.center,
                  ),
                ElevatedButton.icon(
